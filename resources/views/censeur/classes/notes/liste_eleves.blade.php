            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
             ...
             <!-- Boutons d'export -->
                <div class="flex space-x-3">
                    ...
                    <button id="bulletinPdfBtn" 
                            onclick="checkAccessAndShowModal({{ auth()->user()->id }})"
...
function checkAccessAndShowModal(userId) {
    ...
    if (!authorizedIds.includes(userId)) {
        ...
        window.location.href = "{{ route('censeur.classes.bulletin.all-pdf', [$classe->id, $trimestre]) }}";
    }
}
