...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                <div class="p-6 text-center">
                    ...
                    <a href="{{ route('censeur.classes.notes', [$classe->id, $trimestre]) }}"      
        ...
        <div class="text-center py-12">
            ...
            <h4 class="text-lg font-semibold text-gray-900 mb-2">Aucune matière disponibles pour cette classe</h4>
