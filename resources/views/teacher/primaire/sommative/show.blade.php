...
<div class="min-h-screen bg-gray-50 py-4 px-3 sm:py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex flex-wrap gap-2 shrink-0">
            ...
            <a href="{{ route('teacher.primaire.sommative.saisie', [$classe->id, $composition->id, $subject->id]) }}"
               class="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold text-sm px-4 py-2.5 rounded-xl shadow-sm transition">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 text-center">
            ...
            <p class="text-2xl font-black text-orange-600">/{{ number_format($evaluation->note_max, 0) }}</p>
        </div>
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 text-center">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 text-center">
            ...
            <p class="text-sm font-bold {{ $composition->etape === 'saisie' ? 'text-orange-600' : 'text-gray-500' }} mt-1.5">
                {{ $composition->etapeLabel }}
            </p>
        </div>
    </div>
            ...
            <table class="w-full text-sm min-w-[560px]">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 sm:px-6 py-3 text-center">
                            @if($note !== null)
                            <span class="text-lg font-black {{ $pct >= 50 ? 'text-green-700' : 'text-red-600' }}">
