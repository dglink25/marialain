...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <form method="POST" action="{{ route('admin.students.store') }}" enctype="multipart/form-data" class="bg-white shadow-lg border border-gray-200 rounded-xl p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <!-- Numéro éduc -->
        <div>
            <label class="block text-sm font-semibold text-gray-700 mb-1">Numéro éduque Master</label>
        ...
        <!-- Scolarité -->
        <div class="md:col-span-2">
            <label class="block text-sm font-semibold text-gray-700 mb-1">Scolarité payée à l'inscription</label>
            <input type="number" name="school_fees" value="{{ old('school_fees') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
        </div>
    </div>

    <div class="mt-6 text-right">
        <button type="submit" class="bg-blue-600 text-white font-semibold px-6 py-2 rounded-lg shadow hover:bg-blue-700 transition">Enregistrer</button>
    </div>
</form>
