    ...
    <!-- Options de tri -->
        ...
        <div class="flex flex-wrap items-center gap-4 mb-4 text-gray-700">
            ...
            <form action="" method="GET" class="flex items-center">
                ...
                <button type="submit" class="ml-2 bg-blue-600 text-white px-4 rounded-lg shadow hover:bg-blue-700 transition">Trier</button>
            </form>
            
           
         </div>
         <a href="{{ route('primaire.ecoliers.liste') }}" class="px-3 py-1 bg-gray-100 rounded hover:bg-gray-200"> x Voir tout</a>
</div>
        ...
        @else
        <p class="text-gray-500 italic mt-4">Aucun élève inscrit dans le primaire.</p>
        @endif
    </div>
</div>
@endsection
