...
<div class="min-h-screen bg-gray-50 py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Gestion des notes & évaluations</h1>
                <p class="text-sm text-gray-500 mt-0.5">Maternelle &amp; Primaire — {{ $annee_academique->name }}</p>
            </div>
        </div>

        <button onclick="openModal()"
                class="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold text-sm px-5 py-2.5 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 active:scale-95">
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 text-xs uppercase text-gray-500 font-semibold">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left">Classes concernées</th>
                        <th class="px-6 py-3 text-left">Composition (du → au)</th>
                        <th class="px-6 py-3 text-left">Saisie des notes (du → au)</th>
                    </tr>
                </thead>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-5 py-4 flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-white font-bold text-base">{{ $classe->name }}</p>
...
<div id="composition-overlay"
    ...
    <div class="relative flex items-center justify-center min-h-full px-4 py-8">
        <div id="composition-panel"
             class="relative bg-white w-full max-w-xl rounded-2xl shadow-2xl border border-gray-100
            ...
            <div class="flex items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-900">Programmer une composition</h2>
                        <p class="text-xs text-gray-400">{{ $annee_academique->name }}</p>
                    </div>
                </div>
            ...
            {{-- Form --}}
            <form action="{{ route('primaire.notes.composition.store') }}" method="POST" class="px-6 py-5 space-y-5">
                @csrf
